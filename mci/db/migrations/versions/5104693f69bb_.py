...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ethnicity_race', sa.String(length=50), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('pairin_id', sa.String(length=40), nullable=True),
    ...
    sa.Column('ethnicity_and_race_id', sa.Integer(), nullable=True),
    sa.Column('education_level_id', sa.Integer(), nullable=True),
    sa.Column('employment_status_id', sa.Integer(), nullable=True),
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['education_level_id'], ['education_level.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['employment_status_id'], ['employment_status.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['ethnicity_and_race_id'], ['ethnicity_race.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['gender_id'], ['gender.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['mailing_address_id'], ['address.id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['current_status_id'], ['current_status.id'], ),
    sa.ForeignKeyConstraint(['mci_id'], ['individual.mci_id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['mci_id'], ['individual.mci_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('program_id', 'mci_id', 'referring_id', 'date_referred')
    )
